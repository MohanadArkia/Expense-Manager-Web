...
const Index = () => {
  ...
  const togglePasswordVisibility = () => {
      ...
      setPasswordEye(showPassword ? Images.HidePassword() : Images.ShowPassword());
  };
  ...
  return (
    <div className={styles.container} >
        <div className={styles.secondaryContainer}>
            ...
            <TextInput style={styles.txtInput} img={Images.Lock()} imgStyle={styles.icon} placeHolder='Password' type={showPassword ? 'text' : 'password'} secondImg={passwordEye} secondImgStyle={styles.secondImg} secondImgClick={togglePasswordVisibility}/> 
