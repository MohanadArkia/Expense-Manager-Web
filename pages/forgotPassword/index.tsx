  ...
  return (
    <div className={styles.container}>
        <div className={styles.secondaryContainer}>
            ...
            <h5 className={styles.instructionTxt}>Enter your email and check your mail box</h5>
            <TextInput style={styles.txtInput} img={Images.Letter()} imgStyle={styles.icon} placeHolder='Email'/>
            <Button title="Send recovery link" style={styles.btnRecovery} buttonTextStyle={styles.btnRecoveryText}/>
        </div>
    </div>
  )
}
